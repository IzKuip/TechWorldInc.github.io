function navigateTo(url, fromHome = true) {
    if (fromHome) {
        ...
        obj.style.transition = "margin-top 0.5s, opacity 0.75s";
        obj.style.opacity = "1";
        setTimeout(() => {
        ...
        textNode.style.transition = "margin-top 0.5s, opacity 0.75s";
        ...
        textNode1.style.transition = "margin-top 0.5s, opacity 0.75s";
